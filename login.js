...
function login()
{
  ...
  if(username=="codequotient" && password=="codequotient"){
    ...
    setSession(username);
    location.href='adminquestions.html';
}
  else if(username!=""&&password!="")
  {
    ...
    if(flag==0)
    {
      console.log(checkArray); // check Array refers to Userarray
    ...
    else
    {
      ...
      storeFlag(logInArray);
      setSession(username);
      location.href="viewquestions.html";
    }
  }
  else
  {
